...
public class MediaActivity extends Activity implements View.OnClickListener {
    ...
    File destDir = new File(Environment.getExternalStorageDirectory().getPath() + "/demo1/");
    ...
    void initUI() {
        ...
        @SuppressLint("WrongConstant") LinearLayoutManager layoutManager = new LinearLayoutManager(MediaActivity.this, OrientationHelper.VERTICAL,false);
    ...
    private class FileListAdapter extends RecyclerView.Adapter<ItemHolder> {
        ...
        public void onBindViewHolder(ItemHolder mItemHolder, final int index) {
            ...
            if (mediaFile != null) {
                ...
                Log.e("time1",mediaFile.getTimeCreated()+"");
                Log.e("time2",mediaFile.getDateCreated());
                    ...
                    public void onUpdate(final MediaFile mediaFile, FetchMediaTaskContent fetchMediaTaskContent, DJIError error) {
                        if (null == error) {
                            if (mediaFile.getPreview() != null) {
                                ...
                                setResultToToast("空位图!");
                            }
                        } else {
                            setResultToToast("提取预览图像失败: " + error.getDescription());
                        }
                    }
                });
        ...
        scheduler.resume(new CommonCallbacks.CompletionCallback() {
            ...
            public void onResult(DJIError error) {
                if (error == null) {
                    ...
                    setResultToToast("恢复计划程序失败: " + error.getDescription());
                }
            }
        });
    }
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                mMediaManager.moveToPosition(Integer.parseInt(ms),
                        new CommonCallbacks.CompletionCallback() {
                            ...
                            public void onResult(DJIError error) {
                                if (null != error) {
                                    setResultToToast("视频跳转失败" + error.getDescription());
                                } else {
        ...
        switch (v.getId()) {
            ...
            case R.id.pause_btn: {
                mMediaManager.pause(new CommonCallbacks.CompletionCallback() {
                    ...
                    public void onResult(DJIError error) {
                        if (null != error) {
                            setResultToToast("暂时视频失败" + error.getDescription());
                        } else {
